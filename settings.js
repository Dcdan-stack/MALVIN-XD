...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "malvin~Q3EQFK7B#v2cYM2AlQomh0Pp37oZ9u-01EjvWBsu0apCZsQn84gI",
// add your Session Id make sure it starts with malvin~
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "aura",
...
OWNER_NAME: process.env.OWNER_NAME || "Iamdan_james",
// add bot owner name

              DESCRIPTION: process.env.DESCRIPTION || "*Iamdan_james*",
// add bot owner name    
...
// true if want mark commands as read 
     ...
     DEV: process.env.DEV || "255672562733",
